...
function slideImage(value,component){
    if(component === "carousel"){
        document.getElementById("carousel-slider").style.transform = "translate(-"+((12*value)+(value/2))+"%)";
    }
    else if(component === "team"){
        document.getElementById("team-members").style.transform = "translate(-"+(Number((33*value)/2)+((value/33)*7))+"%)";
    }
}
...
function closeSideNav() {
    ...
    if (x.className === "sideNav") {
        x.className = "navigation";
        document.getElementById("openNavBar").style.display ="inline-block";
